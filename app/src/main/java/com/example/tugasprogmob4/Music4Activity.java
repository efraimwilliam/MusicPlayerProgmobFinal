...
public class Music4Activity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        ImageView cover4 = (ImageView) findViewById(R.id.yourcovermusic);
        Bundle bundle = getIntent().getExtras();
        if (bundle!=null){
            int res_image = bundle.getInt("cover4");
            cover4.setImageResource(res_image);
        }
        ...
        //media player
        mp = MediaPlayer.create(this, R.raw.putri_cening_ayu);
        mp.setLooping(true);
        mp.seekTo(0);
    ...
    public void showlyrics (View v){
        if( v == findViewById(R.id.buttonlyric)){
            Lyrics4Fragment fragment = new Lyrics4Fragment();
    ...
    public void onClick(View v) {
        if (v.getId() == R.id.buttonyoutube) {
            Intent intent = new Intent(this, Youtube4Activity.class);

...
public class Music1Activity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        ImageView cover = (ImageView) findViewById(R.id.yourcovermusic);
        Bundle bundle = getIntent().getExtras();
        if (bundle!=null){
            int res_image = bundle.getInt("cover");
        ...
        //media player
        mp = MediaPlayer.create(this, R.raw.macepet_cepetan);
        mp.setLooping(true);
        mp.seekTo(0);
    ...
    public void showlyrics (View v){
        if( v == findViewById(R.id.buttonlyric)){
            Lyrics1Fragment fragment = new Lyrics1Fragment();

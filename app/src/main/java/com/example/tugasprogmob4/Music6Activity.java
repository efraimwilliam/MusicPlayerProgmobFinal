...
public class Music6Activity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        ImageView cover6 = (ImageView) findViewById(R.id.yourcovermusic);
        Bundle bundle = getIntent().getExtras();
        if (bundle!=null){
            int res_image = bundle.getInt("cover6");
            cover6.setImageResource(res_image);
        }
        ...
        //media player
        mp = MediaPlayer.create(this, R.raw.jangi_janger);
        mp.setLooping(true);
        mp.seekTo(0);
    ...
    public void showlyrics (View v){
        ...
        if( v == findViewById(R.id.buttonlyric)){
            Lyrics6Fragment fragment = new Lyrics6Fragment();
    ...
    public void onClick(View v) {
        if (v.getId() == R.id.buttonyoutube) {
            Intent intent = new Intent(this, Youtube6Activity.class);

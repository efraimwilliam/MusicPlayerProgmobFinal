...
public class Music5Activity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        ImageView cover5 = (ImageView) findViewById(R.id.yourcovermusic);
        Bundle bundle = getIntent().getExtras();
        if (bundle!=null){
            int res_image = bundle.getInt("cover5");
            cover5.setImageResource(res_image);
        }
        ...
        //media player
        mp = MediaPlayer.create(this, R.raw.ratu_anom);
        mp.setLooping(true);
        mp.seekTo(0);
    ...
    public void showlyrics (View v){
        ...
        if( v == findViewById(R.id.buttonlyric)){
            Lyrics5Fragment fragment = new Lyrics5Fragment();
            FragmentManager manager = getSupportFragmentManager();

            manager.beginTransaction().replace(R.id.fragmentlyric5, fragment).commit();
    ...
    public void onClick(View v) {
        if (v.getId() == R.id.buttonyoutube) {
            Intent intent = new Intent(this, Youtube5Activity.class);
